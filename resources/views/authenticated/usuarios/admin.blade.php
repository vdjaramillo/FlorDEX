...
<ul class="list-group">
   @section('links')
    ...
    <ul>
        ...
        <a class="usoptin list-group-item bg-soft" style="display:none; transition: all 1s ease 0s; width:90%" href="{{route('tipos_informes_lista')}}"><li >Tipos de Informes</li></a>
    </ul>
    </nav>
    <script>
    function show(clase){
