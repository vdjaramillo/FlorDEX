    ...
    <table class="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{$item->cedula}}</td>
                <td style="text-align:center" onclick="Editar({{$item->cedula}})"><img class="imgbtn" src="{{ asset('img/edit.png') }}" width="25rem" alt="Editar"></td>
                <td style="text-align:center" onclick='Eliminar({{$item->cedula}},"{{$item->name}}")'><img class="imgbtn" src="{{ asset('img/eliminar.png') }}" width="25rem" alt="Eliminar"></td>
            </tr>
            @endforeach
        </tbody>
    </table>
