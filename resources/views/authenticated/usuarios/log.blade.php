...
<form action="{{ route('crear-dex') }}" method="POST">
    ...
    <div class="form-group">
        <label for="declaracion_de_cambio">Declaración de Cambio</label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label for="vr_declaracion">Valor Declaración</label>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <label for="numero_dex">Numero DEX</label>
        <div class="col-md-3">
    ...
    <!--/div>
    <div class="form-group"-->
        <label for="numero_factura">Valor</label>
        <div class="col-md-3">
